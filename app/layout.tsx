...
export const metadata: Metadata = {
  ...
  description: "복잡한 부동산 정책과 금융 뉴스, AI가 실시간으로 분석하여 핵심 정보와 전문가 통찰을 제공합니다. LTV, 세금, 분양 정보를 한눈에 확인하세요.",
  keywords: ["부동산정책", "금융정책", "부동산분석", "LTV", "DSR", "국토교통부", "금융위원회", "정책레이더"],
  authors: [{ name: "Policy Radar Team" }],
  metadataBase: new URL(SITE_URL),
  openGraph: {
    title: "Policy Radar | AI 부동산·금융 정책 분석",
    description: "가장 빠른 부동산 정책 분석 서비스. 전문가의 통찰과 AI 요약을 통해 성공적인 부동산 의사결정을 도와드립니다.",
    url: SITE_URL,
  ...
  twitter: {
    ...
    title: "Policy Radar | AI 부동산·금융 정책 분석",
    description: "복잡한 정책 흐름, AI가 실시간으로 정리해 드립니다.",
    images: ["/logo.svg"],
  },
  appleWebApp: {
    capable: true,
